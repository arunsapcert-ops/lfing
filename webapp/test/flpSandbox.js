		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Lifing app",
									"targetURL": "#compiaggiosaplifinglifing-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"compiaggiosaplifinglifing-display": {
								"semanticObject": "compiaggiosaplifinglifing",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.piaggio.sap.lifing.lifing",
									"url": sap.ui.require.toUrl("com/piaggio/sap/lifing/lifing")
								}
							}
						}
					}
